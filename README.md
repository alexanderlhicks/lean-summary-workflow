    ...
    steps:
      - name: Generate PR Summary
        ...
        with:
          ...
          model: gemini-3.1-flash  # or: claude-opus-4-6-20250415, gpt-5.4-mini
...
| `model` | The LLM model to use (e.g., `gemini-3.1-flash`, `claude-opus-4-6-20250415`, `gpt-5.4-mini`). | Yes | |
